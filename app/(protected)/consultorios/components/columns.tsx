...
import { deleteConsultorio as deleteConsultorio } from "../actions";

export const columns: ColumnDef<Consultorio>[] = [
  {
    accessorKey: "nombre",
    header: ({ column }) => (
      <Button
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <ActionsCell consultorio={consultorio} />;
    },
  },
];

function ActionsCell({ consultorio: consultorio }: { consultorio: Consultorio }) {
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      const result = await deleteConsultorio(consultorio.id);
      if (result.success) {
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <Link href={`/consultorios/${consultorio.id}/edit`}>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              el consultorio {consultorio.nombre}.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
