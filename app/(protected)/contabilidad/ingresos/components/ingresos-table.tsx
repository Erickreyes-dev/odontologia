...
export type IngresoRow = { id:string; fecha:string; tipoIngresoId:string; tipo:string; paciente:string; doctor:string; concepto:string; monto:number; metodoPago:string; origen:string; comentario:string; editable:boolean; honorarioPorcentaje:string; honorarioEstado:string; honorarioLiquidado:number };
