...
export const TENANT_PERMISSIONS: PermissionSeed[] = [
  ...
  { nombre: "ver_promociones", descripcion: "Permiso para ver promociones y paquetes" },
  { nombre: "crear_promociones", descripcion: "Permiso para crear promociones y paquetes" },
  { nombre: "editar_promociones", descripcion: "Permiso para editar promociones y paquetes" },
